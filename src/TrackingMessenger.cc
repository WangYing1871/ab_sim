...
{
  G4cout<<"<<------------TrackingMessenger::TrackingMessenger(TrackingAction* trackA)-------------------->>"<<G4endl;
  fTrackingCmd = new G4UIcmdWithABool("/NTD_Ge/fullChain",this);
...
{
  G4cout<<"<<------------TrackingMessenger::~TrackingMessenger()-------------------->>"<<G4endl;
  delete fTrackingCmd;
}
...
{ 
  G4cout<<"<<------------TrackingMessenger::SetNewValue(G4UIcommand* command, G4String newValue)-------------------->>"<<G4endl;
